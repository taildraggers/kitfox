"""Scrape Kitfox listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Kitfox Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=kitfox&s-original-search=kitfox",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=kitfox"),
    ("ASO", "https://aso.com/search?q=Kitfox"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Kitfox Listings</h2>
    <p>View additional Kitfox listings at these fine sites:</p>
